...
import net.backupcup.mcd_enchantments.item.ModItemGroup;
...
public class ModBlocks {
    ...
    public static final Block RUNIC_TABLE = registerBlock("runic_table",
            new RunicTableBlock(FabricBlockSettings.of(Material.WOOD).strength(2f).nonOpaque()), ModItemGroup.MCDEncahntments);
